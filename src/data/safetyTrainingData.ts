...
export const safeDrivingPracticesModule: TrainingModuleContent = {
  ...
  slides: [
    ...
    },
    {
      ...
      visualDescription: 'Driver holding head, phone in hand'
    },
    {
      id: 5,
      ...
      visualDescription: 'Driver sitting outside vehicle drinking water'
    }
  ]
};
