...
const TrainingSlideViewer: React.FC<TrainingSlideViewerProps> = ({
  ...
  return (
    <div 
      className="flex flex-col h-full min-h-[80vh] bg-white"
      tabIndex={0} 
      onKeyDown={handleKeyDown}
    >
      {/* Module header */}
      <div className="bg-moveinsync-orange/10 px-4 py-3 text-center">
        <h2 className="font-medium text-moveinsync-orange">{moduleContent.name}</h2>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 flex justify-between">
        ...
        <Button 
          ...
          variant="default"
          className="flex-1 ml-2 bg-moveinsync-orange hover:bg-moveinsync-orange/90"
        >
